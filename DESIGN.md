...
- **Motion:** Feedback stays between 70–140ms with named color/shadow transitions. Frequently used tabs and Sign out use smooth ease-out timing; hover uses mid-gray, while solid black is reserved for selected/status states. No hover translation; reduced motion removes non-essential interpolation.
